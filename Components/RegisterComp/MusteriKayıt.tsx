...
const schema = Yup.object({
  ...
  soyisim: Yup.string().required("Soyisim Zorunludur"),
...
const MusteriKayıt = () => {
  ...
  return (
    <Formik validationSchema={schema}
      initialValues={{ isim: "", soyisim: "", TelefonNo: "", email: "", sifre: "" }}
      ...
      {({ handleChange, values, errors, handleSubmit, touched, handleBlur }) => (
        ...
        <View style={styles.formArea}>
          <Input
            ...
            errors={touched.isim && errors.isim ? errors.isim : undefined} />
          <Input
            Title='Soyisim'
            width={330}
            height={72}
            ...
            errors={touched.soyisim && errors.soyisim ? errors.soyisim : undefined}
          />
